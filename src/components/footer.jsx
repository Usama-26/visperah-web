  ...
  return (
    <footer className="bg-white" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-10 sm:pt-16 lg:px-8 lg:pt-20">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600">
              Visperah specializing in modern technology,With the best service
        ...
        <div className=" border-t border-gray-900/10 pt-8 mt-10">
          <p className="text-xs leading-5 text-gray-500 text-center">
            &copy; 2024 Visperah Tech. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
